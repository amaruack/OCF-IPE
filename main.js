...
var ocf_oic_d_receive = function (data) {
    console.log(data);
};
var ocf_oic_res_receive = function (datas) {
    console.log(datas);
...
// // ocf device retrieve
ocf_client_1.ocfClient.ocf_request("coap://10.10.0.198:5683/oic/res", ocf_oic_d_receive);
//
...
// // 3. 없으면 디바이스 생성
//
// // 4-1. upstream 데이터 조회 (OCF - coap 조회 날려서 )
